...
class PklProjectViewNestingRulesProvider : ProjectViewNestingRulesProvider {
  override fun addFileNestingRules(consumer: ProjectViewNestingRulesProvider.Consumer) {
    // make PklProject.deps.json show up as a child of PklProject
    consumer.addNestingRule(PKL_PROJECT_FILENAME, PKL_PROJECT_DEPS_FILENAME)
  }
}
